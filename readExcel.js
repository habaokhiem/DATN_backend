...
axios
  .get(
    "https://sheets.googleapis.com/v4/spreadsheets/1Na16KETL87c1xbvn9PJMsQRy1bvce0i9ZUixuQmxCiQ/values:batchGet?ranges=UNI&majorDimension=ROWS&key=AIzaSyByXzekuWCb4pI-ZTD7yEAGVYV0224Mc6Q"
  )
  .then(async (res) => {
    const data = res.data.valueRanges[0].values;
    console.log("data: ", data);
    let newData = await query(
      "INSERT INTO university (id, code, university) values ?",
